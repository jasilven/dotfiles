...
set -gx FZF_DEFAULT_OPTS --layout=reverse --color=bg+:-1,bg:-1,spinner:#81A1C1,hl:3,fg:#6c6c6c,header:#616E88,info:#81A1C1,pointer:3,marker:#81A1C1,fg+:3,prompt:#81A1C1,hl+:3
