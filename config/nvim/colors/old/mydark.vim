...
hi Normal ctermbg=234 ctermfg=252 guibg=#1d2021 guifg=#bfbfbf
...
hi Conceal ctermbg=234 ctermfg=242 guibg=#1d2021 guifg=#6b7089
hi Constant ctermfg=140 guifg=#a093c7
hi Cursor ctermbg=252 ctermfg=234 guibg=#bfbfbf guifg=#1d2021
hi CursorLineNr cterm=NONE ctermbg=237 ctermfg=253 guibg=#1e2132 guifg=#cdd1e6
hi Delimiter ctermfg=252 guifg=#bfbfbf
...
hi DiffText cterm=NONE ctermbg=30 ctermfg=195 gui=NONE guibg=#5b7881 guifg=#bfbfbf
hi Directory ctermfg=109 guifg=#89b8c2
hi Error ctermbg=234 ctermfg=203 guibg=#1d2021 guifg=#e27878
hi ErrorMsg ctermbg=234 ctermfg=203 guibg=#1d2021 guifg=#e27878
hi WarningMsg ctermbg=234 ctermfg=203 guibg=#1d2021 guifg=#e27878
hi EndOfBuffer ctermbg=234 ctermfg=236 guibg=#1d2021 guifg=#242940
hi NonText ctermbg=234 ctermfg=236 guibg=#1d2021 guifg=#242940
hi SpecialKey ctermbg=234 ctermfg=236 guibg=#1d2021 guifg=#242940
hi Folded ctermbg=235 ctermfg=245 guibg=#1e2132 guifg=#686f9a
hi FoldColumn ctermbg=235 ctermfg=239 guibg=#1e2132 guifg=#444b71
hi Function ctermfg=110 guifg=#84a0c6
hi Identifier cterm=NONE ctermfg=109 guifg=NONE
hi Ignore ctermbg=NONE ctermfg=NONE guibg=NONE guifg=NONE
hi Include ctermfg=110 guifg=NONE
hi IncSearch cterm=reverse ctermfg=NONE gui=reverse guifg=NONE term=reverse
hi LineNr ctermbg=235 ctermfg=239 guibg=NONE guifg=#444b71
hi MatchParen ctermbg=237 ctermfg=255 guibg=#3e445e guifg=#ffffff
hi ModeMsg ctermfg=242 guifg=#6b7089
hi MoreMsg ctermfg=150 guifg=#b4be82
hi Operator ctermfg=110 guifg=#84a0c6
hi Pmenu ctermbg=236 ctermfg=251 guibg=#282828 guifg=#bfbfbf
...
hi PmenuThumb ctermbg=251 ctermfg=NONE guibg=#bfbfbf guifg=NONE
hi PreProc ctermfg=150 guifg=#b4be82
hi Question ctermfg=150 guifg=#b4be82
hi QuickFixLine ctermbg=236 ctermfg=252 guibg=#272c42 guifg=#bfbfbf
...
hi Statement ctermfg=110 gui=NONE guifg=NONE
hi Keyword ctermfg=110 gui=NONE guifg=#7393bf
...
hi TabLineSel cterm=NONE ctermbg=234 ctermfg=252 gui=NONE guibg=#1d2021 guifg=#9a9ca5
hi TermCursorNC ctermbg=242 ctermfg=234 guibg=#6b7089 guifg=#1d2021
hi Title ctermfg=216 gui=NONE guifg=#e2a478
hi Todo ctermbg=234 ctermfg=150 guibg=#45493e guifg=#b4be82
hi Type ctermfg=110 gui=NONE guifg=NONE
hi Underlined cterm=underline ctermfg=110 gui=underline guifg=#84a0c6 term=underline
hi VertSplit cterm=NONE ctermbg=233 ctermfg=233 gui=NONE guibg=NONE guifg=#444b71
...
hi LspDiagnosticsError ctermfg=203 guifg=#6b7089
hi LspDiagnosticsWarning ctermfg=216 guifg=#6b7089
...
hi gitmessengerPopupNormal ctermbg=235 ctermfg=252 guibg=#1e2132 guifg=#bfbfbf
hi Sneak ctermbg=140 ctermfg=234 guibg=#a093c7 guifg=#1d2021
...
hi rustExternCrate guifg=NONE
hi rustAttribute guifg=NONE
...
hi! link jsModuleKeywords Keyword 
...
if has('nvim')
  ...
  let g:terminal_ansi_colors = ['#1e2132', '#e27878', '#b4be82', '#e2a478', '#84a0c6', '#a093c7', '#89b8c2', '#bfbfbf', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#ada0d3', '#95c4ce', '#d2d4de']
endif
